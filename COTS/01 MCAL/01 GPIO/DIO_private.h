...
#define		GPIOA_ODR_LOW		*((u8 *)(GPIOA_BASE_ADD+0x0C))
#define		GPIOA_ODR_HIGH		*((u8 *)(GPIOA_BASE_ADD+0x0D))
...
#define		GPIOB_ODR_LOW		*((u8 *)(GPIOB_BASE_ADD+0x0C))
#define		GPIOB_ODR_HIGH		*((u8 *)(GPIOB_BASE_ADD+0x0C))
